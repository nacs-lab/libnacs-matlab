...
classdef TestSeqContext < matlab.unittest.TestCase
    ...
    methods(Test)
        function dotest(test)
            ...
            test.verifyEqual(na0, uint32(4));
            test.verifyEqual(ctx.getValID(arg0), na0);

            nm1 = ctx.getValID(m1);
            test.verifyEqual(nm1, uint32(5));
            test.verifyEqual(ctx.getValID(m1), nm1);

            ng0 = ctx.getValID(g0);
            test.verifyEqual(ng0, uint32(6));
