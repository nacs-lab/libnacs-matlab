function varargout = RunScans2(scangroup, seq, varargin)
% RunScans(scangroup)
...
Scan = getfields(scanp, 'AndorCenter', 'BoxSize', 'FrameSize', ...
                 ...
                 'SurvivalLoadingLogicals', 'SurvivalLogicals', 'RearrLogicals', 'RearrResult',...
...
scan_id = str2double(CurrentDate) * 1e6 + str2double(CurrentTime);
...
m.Data(1).ScanParamsSet = 0;
disp(['Starting scan ' CurrentDate '_' CurrentTime])
